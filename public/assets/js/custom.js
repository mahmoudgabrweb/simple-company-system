...
//________ footer fixed on bottom function by = custom.js	________//		 
    ...
    ===========================*/
    // Project Modal Bootstrap Event Handler (if needed for dynamic content)
...
//________Switcher panal slide function END	________//	
    ...
    // Social Media Chat Widget functionality
    let isWidgetOpen = false;
    let hoverTimeout;

    // Toggle widget on click
    $(document).on('click', '#socialChatMain', function (e) {
        e.preventDefault();
        e.stopPropagation();
        toggleSocialWidget();
    });
    ...
    $(document).on('mouseenter', '#socialChatWidget', function () {
    ...
    // Hide widget when mouse leaves (with delay)
    $(document).on('mouseleave', '#socialChatWidget', function () {
        if (!isWidgetOpen) {
    ...
    $(document).on('click', function (e) {
        if (!$(e.target).closest('#socialChatWidget').length && isWidgetOpen) {
            toggleSocialWidget();
        }
    });
    ...
    function showSocialWidget() {
        $('#socialChatWidget').addClass('active');
        $('#socialChatMain').addClass('pulse');
        setTimeout(function () {
            $('#socialChatMain').removeClass('pulse');
        }, 2000);
    }

    function hideSocialWidget() {
        $('#socialChatWidget').removeClass('active');
    }

    // Add pulse effect periodically to attract attention
    setInterval(function () {
        if (!isWidgetOpen && !$('#socialChatWidget').hasClass('active')) {
            $('#socialChatMain').addClass('pulse');
            setTimeout(function () {
                $('#socialChatMain').removeClass('pulse');
            }, 2000);
