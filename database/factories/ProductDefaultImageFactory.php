 ...
 */
class ProductDefaultImageFactory extends Factory
{
    /**
    ...
    public function definition()
    {
        ...
        $folderName = env("APP_ENV") === "local" ? "public/product_default_images" : "product_default_images";
        list($isUploaded, $uploadedImage) = $uploadFileService->uploadImage($uploadedFile, $folderName);
        unlink($tempPath);

        return [
            'main_image' => $uploadedImage,
            'is_active' => 1,
        ];
    }
}
