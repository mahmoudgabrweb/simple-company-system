...
class SiteClientsPermissionSeeder extends Seeder
{
    public function run(): void
    {
        $modelName = "site_clients";

        // Generate permissions (browse, read, edit, add, delete)
        Permission::generateFor($modelName);

        $upperCase = "Site Clients";
        $upperCaseSingular = "SiteClient";
        $controllerName = "SiteClientController";
