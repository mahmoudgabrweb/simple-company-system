...
class ProjectExpensesPermissionSeeder extends Seeder
{
    public function run(): void
    {
        $modelName = "project_expenses";

        // Permissions
        Permission::generateFor($modelName);

        $upperCase = "مصروفات المشاريع";
        $upperCaseSingular = "ProjectExpense";
        $iconClass = "voyager-receipt";

        $controllerName = "ProjectExpenseController";
