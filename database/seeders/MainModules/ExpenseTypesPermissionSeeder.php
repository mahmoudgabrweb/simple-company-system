...
class ExpenseTypesPermissionSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $upperCase = "أنواع المصروفات";
        $upperCaseSingular = "ExpenseType";
        $controllerName = "ExpenseTypeController";
        $iconClass = "voyager-wallet";
