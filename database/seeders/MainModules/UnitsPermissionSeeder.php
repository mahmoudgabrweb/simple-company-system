...
class UnitsPermissionSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $upperCase = "الوحدات";
        $upperCaseSingular = "Unit";
        $controllerName = "UnitController"; // if you’re using Voyager default, leave empty
        $iconClass = "voyager-params";
        ...
        if (!$dataType->exists) {
            $dataType->fill([
                ...
                'controller' => "", // use Voyager default BREAD
                'generate_permissions' => 1,
                'description' => '',
                'server_side' => 1,
                'details' => '{"order_column":"id","order_display_column":"id","order_direction":"desc","default_search_key":"code"}',
            ])->save();
        }
