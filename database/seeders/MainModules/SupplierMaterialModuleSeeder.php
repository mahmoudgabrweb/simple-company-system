...
class SupplierMaterialModuleSeeder extends Seeder
{
    public function run(): void
    {
        $modelName = "supplier_materials";

        // Permissions
        Permission::generateFor($modelName);

        $upperCase = "Supplier Materials";
        $upperCaseSingular = "SupplierMaterial";
        $controllerName = "SupplierMaterialController";
