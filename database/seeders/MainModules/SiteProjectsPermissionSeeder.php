...
class SiteProjectsPermissionSeeder extends Seeder
{
    public function run(): void
    {
        $modelName = "site_projects";

        // Generate permissions (browse, read, edit, add, delete)
        Permission::generateFor($modelName);

        $upperCase = "Site Projects";
        $upperCaseSingular = "SiteProject";
        $controllerName = "SiteProjectController";
