...
@section('content')
    <div class="container-xxl py-3">
        <div class="d-flex justify-content-between align-items-center mb-3">
            <h4 class="m-0">تفاصيل مالية — {{ $project->name }}</h4>
            <div>
                <a href="{{ route('voyager.projects.index') }}" class="btn btn-secondary">رجوع</a>
                <a href="{{ route('voyager.projects.edit', $project->id) }}" class="btn btn-warning">تعديل المشروع</a>
            </div>
        </div>
        ...
        <div class="row g-3">
            <div class="col-lg-6">
                <div class="card p-3 h-100">
                    <div class="d-flex justify-content-between align-items-center mb-2">
                        <h5 class="m-0">المدفوعات</h5>
                        <a href="{{ route('voyager.payments.create') }}" class="btn btn-sm btn-primary">+ دفعة</a>
                    </div>
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover mb-0 align-middle">
                            ...
                            @empty
                                <tr>
                                    <td colspan="6" class="text-center text-muted py-3">لا توجد مدفوعات.</td>
                                </tr>
                            @endforelse
                            </tbody>
                        </table>
            ...
            <div class="col-lg-6">
                <div class="card p-3 h-100">
                    <div class="d-flex justify-content-between align-items-center mb-2">
                        <h5 class="m-0">مصروفات المشروع</h5>
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover mb-0 align-middle">
                            ...
                            @empty
                                <tr>
                                    <td colspan="6" class="text-center text-muted py-3">لا توجد مصروفات.</td>
                                </tr>
                            @endforelse
                            </tbody>
                        </table>
