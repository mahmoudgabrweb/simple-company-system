            ...
            <div class="card p-3 mb-3">
                ...
                <div class="row g-3 mt-2">
                    <div class="col-md-6">
                        ...
                        <textarea name="address" rows="3" class="form-control" dir="rtl">{{ old('address') }}</textarea>
                    </div>
                    <div class="col-md-3">
                        <label class="form-label">الموقع (وصف قصير / إحداثيات)</label>
                        <input type="text" name="location" class="form-control" value="{{ old('location') }}" dir="ltr">
                    </div>
                    <div class="col-md-3">
                        <label class="form-label">خريطة جوجل (رابط/تضمين)</label>
                        <textarea name="map" rows="3" class="form-control" dir="ltr"
