...
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        {{-- Form --}}
        <form action="{{ route('voyager.site_services.store') }}"
              method="POST"
                ...
                <div class="row g-3 mt-2">
                    ...
                    <div class="col-md-12">
                        ...
                        <textarea name="short_description"
                                  rows="3"
                                  class="form-control"
                                  placeholder="Text shown on the service card">{{ old('short_description') }}</textarea>
                    </div>
                    ...
                    <div class="col-md-12">
                        ...
                        <textarea name="description"
                                  ...
                                  placeholder="Full text shown inside the modal">{{ old('description') }}</textarea>
                    </div>
                </div>
