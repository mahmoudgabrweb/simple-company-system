...
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        <div class="d-flex justify-content-between align-items-center mb-3">
            <h4 class="m-0">Edit Client</h4>
            <a href="{{ route('voyager.clients.index') }}" class="btn btn-secondary">Back</a>
        </div>
            ...
            <div class="card p-3 mb-3">
                ...
                <div class="row g-3 mt-2">
                    <div class="col-md-6">
                        ...
                        <textarea name="map" rows="3" class="form-control"
                                  placeholder="Google Maps URL or embed code">{{ old('map', $client->map) }}</textarea>
                    </div>
                    <div class="col-md-6">
                ...
                <div class="row g-3 mt-2">
                    <div class="col-md-12 small text-muted">
                        Created at: {{ optional($client->created_at)->format('Y-m-d H:i') ?? '—' }} —
                        Last updated: {{ optional($client->updated_at)->format('Y-m-d H:i') ?? '—' }}
                    </div>
                </div>
            </div>
