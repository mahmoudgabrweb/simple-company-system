            ...
            <div class="card p-3 mb-3">
                        ...
                        @if($employee->cv_path)
                            <div class="mb-1">
                                <a href="{{ Storage::disk('public')->url($employee->cv_path) }}" target="_blank"
                                   class="btn btn-sm btn-outline-info">View current file</a>
                            </div>
                        @endif
                ...
                <div class="row g-3 mt-2">
                    <div class="col-md-12 small text-muted">
                        Created at: {{ optional($employee->created_at)->format('Y-m-d H:i') ?? '—' }} —
                        Last updated: {{ optional($employee->updated_at)->format('Y-m-d H:i') ?? '—' }}
                    </div>
                </div>
            </div>
