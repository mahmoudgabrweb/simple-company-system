...
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        <div class="d-flex justify-content-between align-items-center mb-3">
            <h4 class="m-0">Add Expense</h4>
            <a href="{{ route('voyager.expenses.index') }}" class="btn btn-secondary">Back</a>
        </div>

        <form action="{{ route('voyager.expenses.store') }}" method="post">
            @csrf
            ...
            <div class="card p-3 mb-3">
                <div class="row g-3">
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="date" name="spent_at" class="form-control" value="{{ old('spent_at') }}">
                        <div class="form-text">Leave empty to default to today.</div>
                    </div>
                    <div class="col-md-5">
