...
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <h5 class="card-header">إضافة دور</h5>
                    <div class="card-body">
                        <form method="POST" action="{{ route("voyager.$moduleName.store") }}" class="row g-4">
                            ...
                            <div class="col-md-6">
                                <label for="name" class="form-label">
                                    اسم النظام (name) <span class="text-danger">*</span>
                                </label>
                            ...
                            {{-- حالة الدور (اختياري: اتركه إن كان عندك عمود is_active) --}}
                            <div class="col-md-6">
                            ...
                            <div class="col-12">
                                ...
                                <a href="{{ route("voyager.$moduleName.index-new") }}" class="btn btn-secondary">إلغاء</a>
                            </div>
                        </form>
                    </div>
                </div>
