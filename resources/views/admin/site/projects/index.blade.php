    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="d-flex justify-content-between align-items-center mb-3">
            ...
            <div class="d-flex gap-2">
                <a href="{{ route('voyager.site_projects.create') }}" class="btn btn-primary">
                    <i class="bx bx-plus"></i> Add Project
                </a>
                <a href="{{ route('voyager.site_projects.index') }}" class="btn btn-secondary">Reset</a>
            </div>
        </div>
        ...
        <div class="card mb-3">
            <div class="card-body">
                <form method="get" action="{{ route('voyager.site_projects.index') }}" class="row g-2 align-items-end">
                    <div class="col-md-3">
            ...
            <div class="card-body">
                <div class="table-responsive">
                    <table class="table table-striped align-middle">
                        ...
                        <tbody>
                        @forelse($projects as $i => $r)
                            <tr>
                                <td>{{ ($projects->currentPage() - 1) * $projects->perPage() + $i + 1 }}</td>
                                <td>
                                ...
                                <td>
                                    @php $module = 'projects'; $u = auth()->user(); @endphp
...
@section('js_scripts')
    <script src="{{ asset('admin-assets/js/delete-record.js') }}"></script>
@endsection
