...
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <form action="{{ route('voyager.services.store') }}" method="POST">
            @csrf
                ...
                <div class="card-body row g-3">
                    <div class="col-md-6">
                        ...
                        <input type="text" name="title" class="form-control"
                               value="{{ old('title') }}" maxlength="190" required>
                    </div>
                    <div class="col-md-3">
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="number" name="display_order" class="form-control"
                               value="{{ old('display_order', 0) }}" min="0" step="1">
                    </div>
                    <div class="col-md-12">
                        <label class="form-label">Excerpt</label>
                        <input type="text" name="excerpt" class="form-control"
                               value="{{ old('excerpt') }}" maxlength="500" placeholder="Short summary shown in cards">
                    </div>
                    <div class="col-md-6">
                        <label class="form-label">Icon</label>
                        <input type="text" name="icon" class="form-control"
                               value="{{ old('icon') }}" placeholder="e.g., bx bx-home or /uploads/icons/service.png">
                    </div>
            ...
            <div class="card form-card mb-3">
                ...
                <div class="card-body">
                    {{-- If you have TinyMCE initialized globally, this will pick it up --}}
...
@section('js_scripts')
    {{-- No extra JS needed; relies on your global editors (e.g., TinyMCE) if present --}}
@endsection
