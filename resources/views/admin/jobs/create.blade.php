    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <form action="{{ route('voyager.jobs.store') }}" method="post" id="job-form">
                ...
                <div class="row g-3 align-items-end">
                    ...
                    <div class="col-md-3">
                        ...
                        <select name="is_active" class="form-select">
                            ...
                            <option value="0" @selected(old('is_active', 1) == 0)>لا</option>
                        </select>
                    </div>

                    <div class="col-md-3">
                        <label class="form-label">الشركة</label>
                        {{-- للعرض فقط: سيتم الحفظ على الشركة المختارة من السياق --}}
                        <input type="text" class="form-control"
                               value="{{ $currentCompany->name ?? 'سيتم الحفظ على الشركة الحالية' }}"
                               disabled>
                    </div>
                </div>
            </div>
            ...
            <div class="card p-3 mb-3">
                ...
                <textarea name="description" rows="8" class="form-control" dir="rtl">{{ old('description') }}</textarea>
...
@section('js_scripts')
    ...
    <script>
        // ---------- Select2 defaults (theme + RTL + placeholder) ----------
        if ($.fn.select2) {
        ...
        // تفعيل الشكل الموحد لـ select في هذه الصفحة (حتى لو ما عندنا AJAX)
        $(function () {
