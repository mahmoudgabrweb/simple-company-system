...
@section('content')
    <div class="container-xxl py-3">
        <div class="d-flex justify-content-between align-items-center mb-3">
            <h4 class="m-0">Edit Expense #{{ $expense->id }}</h4>
        ...
        <form action="{{ route('voyager.project_expenses.update', $expense->id) }}"
              method="post"
                    ...
                    @if($expense->attachment_path)
                        <div class="mt-1">
                            <a class="btn btn-sm btn-outline-secondary"
                               href="{{ route('admin.project-expenses.attachment', $expense->id) }}">
                ...
                <div class="col-md-6">
                    ...
                    <select name="paid_by_employee_id" class="form-select">
                        ...
                        @foreach($employees as $e)
                            <option value="{{ $e->id }}" @selected($expense->paid_by_employee_id==$e->id)">
